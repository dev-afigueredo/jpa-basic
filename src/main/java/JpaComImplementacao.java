...
public class JpaComImplementacao {
    ...
    public static void main(String[] args) {
        ...
        Estado estadoParaAdicionar = new Estado("Rio Grande do Norte", "RN");
        Aluno alunoParaAdicionar = new Aluno("Neguinha", 30, estadoParaAdicionar);

        // 2.2 - Iniciar uma transacao para adicionar as instancias no banco de dados
        ...
        alunoEncontrado.setNome("Axel");
        alunoEncontrado.setIdade(27);
